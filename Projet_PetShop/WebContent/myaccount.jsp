...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <p class="details">
             Connectez-vous pour pouvoir acheter et vendre des articles, commander en ligne depuis votre espace client, suivre l'avancement de votre colis en temps réel et pleins d'autres services..
            </p>
            
              	<div class="contact_form">
                <div class="form_subtitle">login into your account</div>
                 <form name="register" action="servseconnecter" method="post">          
                    <div class="form_row">
